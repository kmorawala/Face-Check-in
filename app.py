...
root = tk.Tk()
root.withdraw()
print("Please select the folder where the classes/subfolders are located:")
...
root = tk.Tk()
root.withdraw()
print("Please select the folder where the subfolder contains the images to be recognized:")
...
root = tk.Tk()
root.withdraw()
print("Please select the subfolder where the images to be recognized are directly stored.")
file_path = filedialog.askdirectory()
print("Processing...")
# print("Selected folder path: " + file_path)
...
for dist in dists[num_of_classes:]:
    ...
    print('Model detected the image of {} as '.format(
...
print('A total of {} images processed.'.format(count))
